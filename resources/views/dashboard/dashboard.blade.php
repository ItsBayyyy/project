                                                ...
                                                <div class="mt-3 mt-lg-0">
                                                    <form action="javascript:void(0);">
                                                        <div class="row g-3 mb-0 align-items-center">
                                                            ...
                                                            <!--end col-->
                                                            <div class="col-auto">
                                                                <button type="button" class="btn btn-soft-success btn-icon waves-effect waves-light layout-rightside-btn"><i class="ri-pulse-line"></i></button>
                                                            </div>
                                                            <!--end col-->
                                                        </div>
                                                        <!--end row-->
                                        ...
                                        <div class="col-xl-3 col-md-6">
                                            ...
                                            <div class="card card-animate">
                                                <div class="card-body">
                                                    ...
                                                    <div class="d-flex align-items-end justify-content-between mt-4">
                                                        <div>
                                                            <h4 class="fs-20 fw-semibold ff-secondary mb-4">$<span class="counter-value" data-target="165.89">0</span>k </h4>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <div class="d-flex align-items-center">
                                                                            ...
                                                                            <div class="flex-grow-1">
                                                                                <h5 class="fs-14 my-1"><a href="apps-ecommerce-seller-details.html" class="text-reset">Digitech Galaxy</a></h5>
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex align-items-center">
                                                                            ...
                                                                            <div class="flex-gow-1">
                                                                                <h5 class="fs-14 my-1"><a href="apps-ecommerce-seller-details.html" class="text-reset">Nesta Technologies</a></h5>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <div class="d-flex align-items-center">
                                                                            ...
                                                                            <div class="flex-grow-1">
                                                                                <h5 class="fs-14 my-1"><a href="apps-ecommerce-seller-details.html" class="text-reset">Zoetic Fashion</a></h5>
                                                    ...
                                                    <div class="table-responsive table-card">
                                                        <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td>
                                                                        <a href="apps-ecommerce-order-details.html" class="fw-medium text-reset">#VZ2112</a>
                                                                    </td>
                                                                    <td>
                                                                        <div class="d-flex align-items-center">
                                                                            <div class="flex-shrink-0 me-2">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <a href="apps-ecommerce-order-details.html" class="fw-medium text-reset">#VZ2111</a>
                                                                    </td>
                                                                    <td>
                                                                        <div class="d-flex align-items-center">
                                                                            <div class="flex-shrink-0 me-2">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <a href="apps-ecommerce-order-details.html" class="fw-medium text-reset">#VZ2109</a>
                                                                    </td>
                                                                    <td>
                                                                        <div class="d-flex align-items-center">
                                                                            <div class="flex-shrink-0 me-2">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <a href="apps-ecommerce-order-details.html" class="fw-medium text-reset">#VZ2108</a>
                                                                    </td>
                                                                    <td>
                                                                        <div class="d-flex align-items-center">
                                                                            <div class="flex-shrink-0 me-2">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <a href="apps-ecommerce-order-details.html" class="fw-medium text-reset">#VZ2107</a>
                                                                    </td>
                                                                    <td>
                                                                        <div class="d-flex align-items-center">
                                                                            <div class="flex-shrink-0 me-2">
