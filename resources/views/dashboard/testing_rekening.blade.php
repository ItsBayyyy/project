...
@include('dashboard.part.header_nav')
                        ...
                        <div class="col-xxl-3">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-4">
                                        <div class="flex-grow-1">
                                            <h5 class="card-title mb-0">Kerabat</h5>
                                    ...
                                    @if(isset($dataKerabat) && is_array($dataKerabat) && count($dataKerabat) > 0)
                                    <ul>
                                        @foreach($dataKerabat as $kerabat)
                                            <li>
                                                Nama: {{ $kerabat['nama_lengkap'] ?? 'N/A' }}<br>
                                                Hubungan: {{ $kerabat['hubungan_dengan'] ?? 'N/A' }}<br>
                                                Nomor Telepon: {{ $kerabat['nomor_telp'] ?? 'N/A' }}
                                            </li>
                                        @endforeach
                                    </ul>
                                @else
                                    <p>Tidak ada data kerabat yang tersedia.</p>
                                @endif
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    @if(isset($dataRekening) && is_array($dataRekening) && count($dataRekening) > 0)
                                    <ul>
                                        @foreach($dataRekening as $rekening)
                                            <li>
                                                Nama: {{ $rekening['nama_lengkap'] ?? 'N/A' }}<br>
                                                Hubungan: {{ $rekening['hubungan_dengan'] ?? 'N/A' }}<br>
                                                Nomor Telepon: {{ $rekening['nomor_telp'] ?? 'N/A' }}
                                            </li>
                                        @endforeach
                                    </ul>
                                @else
                                    <p>Tidak ada data rekening yang tersedia.</p>
                                @endif
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-4">
                                        <div class="flex-grow-1">
                                            <h5 class="card-title mb-0">Ahli Waris</h5>
                                           
                                        </div>
                                        <!-- <div class="flex-gr">
                                        < class="card-title mb-0">Rekening</  h5>
                                        </div> -->
                                        <div class="flex-shrink-0">
                                            <a href="javascript:void(0);" class="badge bg-light text-primary fs-12"><i class="ri-add-fill align-bottom me-1"></i> Add</a>
                                        </div>
                                    ...
                                    @if(isset($dataAhliWaris) && is_array($dataAhliWaris) && count($dataAhliWaris) > 0)
                                    <ul>
                                        @foreach($dataAhliWaris as $AhliWaris)
                                            <li>
                                                Nama: {{ $AhliWaris['nama_lengkap'] ?? 'N/A' }}<br>
                                                Hubungan: {{ $AhliWaris['hubungan_dengan'] ?? 'N/A' }}<br>
                                                Nomor Telepon: {{ $AhliWaris['nomor_telp'] ?? 'N/A' }}
                                            </li>
                                        @endforeach
                                    </ul>
                                @else
                                    <p>Tidak ada data Ahli Waris yang tersedia.</p>
                                @endif
                                    ...
                                    <ul class="nav nav-tabs-custom rounded card-header-tabs border-bottom-0" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" data-bs-toggle="tab" href="#personalDetails" role="tab">
                                                <i class="fas fa-home"></i> ADD Rekening
                                            </a>
                                        </li>
                                        <li class="nav-item">
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="firstnameInput" name="nama_lengkap" placeholder="Enter your name">
            </div>
        </div>
        <div class="col-lg-6">
            <div class="mb-3">
                <label for="relationshipInput" class="form-label">Hubungan Dengan</label>
                <select class="form-select" id="relationshipInput">
                    <option name="hubungan_dengan" value="" disabled>Pilih Hubungan</option>
                    <option name="hubungan_dengan" value="anak">Anak</option>
                    <option name="hubungan_dengan" value="istri">Istri</option>
                    <option name="hubungan_dengan" value="suami">Suami</option>
                    <option name="hubungan_dengan" value="orang_tua">Orang Tua</option>
                    <option name="hubungan_dengan" value="saudara">Saudara</option>
                    </select>
            </div>
        </div>
        <div class="col-lg-6">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="nomor_telp" id="phonenumberInput" placeholder="Enter your phone number">
            </div>
        </div>
        <div class="col-lg-12">
                                        ...
                                        <div class="tab-pane" id="changePassword" role="tabpanel">
                                            ...
                                            <form id="formChangePassword">
                                                <div class="row g-2">
                                                    <div class="col-lg-4">
                                                        <div class="mb-3">
                                                            <label class="form-label" for="old-password-input">Kata Sandi Lama <span class="text-danger">*</span></label>
                                                            <div class="position-relative auth-pass-inputgroup">
                                                                <input type="password" name="old_password" class="form-control pe-5 password-input" onpaste="return false" placeholder="Masukkan kata sandi lama" id="old-password-input" aria-describedby="passwordInput">
                                                                <button class="btn btn-link position-absolute end-0 top-0 text-decoration-none text-muted password-addon" type="button" onclick="togglePasswordVisibility('old-password-input', this)">
                                                                    <i class="ri-eye-fill align-middle"></i>
                                                                </button>
                                                                <div id="old_password-error" class="text-danger-emphasis"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-lg-4">
                                                        <div class="mb-3">
                                                            <label class="form-label" for="new-password-input">Kata Sandi Baru <span class="text-danger">*</span></label>
                                                            <div class="position-relative auth-pass-inputgroup">
                                                                <input type="password" name="new_password" class="form-control pe-5 password-input" onpaste="return false" placeholder="Masukkan kata sandi baru" id="new-password-input" aria-describedby="passwordInput">
                                                                <button class="btn btn-link position-absolute end-0 top-0 text-decoration-none text-muted password-addon" type="button" onclick="togglePasswordVisibility('new-password-input', this)">
                                                                    <i class="ri-eye-fill align-middle"></i>
                                                                </button>
                                                                <div id="new_password-error" class="text-danger-emphasis"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-lg-4">
                                                        <div class="mb-3">
                                                            <label class="form-label" for="confirm-password-input">Konfirmasi Kata Sandi <span class="text-danger">*</span></label>
                                                            <div class="position-relative auth-pass-inputgroup">
                                                                <input type="password" name="confirm_password" class="form-control pe-5 password-input" onpaste="return false" placeholder="Masukkan konfirmasi Kata sandi" id="confirm-password-input" aria-describedby="passwordInput">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="mb-3">
                                                            <a href="/forgot_password" class="link-primary text-decoration-underline">Lupa Kata Sandi?</a>
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-lg-12">
                                                        <div class="text-end">
                                                            <button type="submit" class="btn btn-secondary">Ganti Kata Sandi</button>
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                </div>
                                            ...
                                            <form>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="hstack gap-2">
                                                        ...
                                                        <a href="javascript:new_link()" class="btn btn-secondary">Add New</a>
                                                    </div>
                                                </div>
                                                <!--end col-->
                                            </form>
